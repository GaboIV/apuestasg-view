...
export class PartidosService {
  ...
  filtrarPartidos(pagina: number, category_id, country_id, start, criterio, dateThan = false) {
    let url = URL_PARTIDOS + '/byFilters?page=' + pagina;

    return this.http.post(url, { category_id: category_id, country_id: country_id, start: start, name: criterio, date_greater_than: dateThan }, this._loginService.httpOptions)
      .pipe(map((resp: any) => {
        return resp;
      }));
  }
